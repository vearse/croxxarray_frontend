  ...
  <div>
    <div class="container">
        <div class="row my-3">
            ...
            <div class="col-12">
                <CNav variant="tabs">
                  <CNavItem to="/assembly"  active>
                    Subcomponent
                  </CNavItem>
                  <CNavItem to="/assembly/subassembly">
                    Sub-assembly
                  </CNavItem>
                  <CNavItem to="/assembly/checklist">
                    Checklist
                  </CNavItem>
                </CNav>
            </div>
                  ...
                  <div class="p-2">
                      <div class="header clearfix">
                        ...
                        <div class=" float-right">
                          <CButton class="bg-croxx-secondary rounded-10p mr-3 w-24 shadow-sm">  <router-link :to="'/assembly/subcomponent/create'" class="card-link" > Create </router-link> </CButton>
