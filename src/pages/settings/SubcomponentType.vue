  ...
  <div>
    <div class="container">
        <div class="row mt-2 mb-4 ">
            <div class="col-8">
              <h4 class="h4 ml-3 font-bold">Subcomponent Types</h4>
            </div>
            <div class="col-4">
    ...
    >
      <template slot="header">
          <h5 class="h5 bold">{{ (form.editmode) ? 'Edit' : 'Create'  }}  Subcomponent Types</h5>
...
export default {
  ...
  methods: {
    ...
    createNewComponent(){
      let vm = this;
      this.$store.dispatch('componentTypes/create', this.form) 
        .then(result => {
    ...
    updateComponentRecord(){
       let vm = this;
        this.$store.dispatch('componentTypes/update', { id:this.form.id, payload: this.form}) 
        .then(result => {
          if (this.success !== false && this.error === false) {
            this.loadRecords();
            this.createModal = false;
